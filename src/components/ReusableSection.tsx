...
function ReusableSection<T extends string = string>({
  ...
  return (
    // <section className=" border-2 rounded-[16px] border-dashed border-dark-15 mb-[100px] max-2xl:mb-[80px] max-md:mb-[50px]">
    //   <div
    ...
    //   <div>{children}</div>
    // </section>
     <section className="border-2 border-dashed rounded-[16px] border-dark-15 mb-[100px] max-2xl:mb-[80px] max-md:mb-[50px]">
      ...
      <div
        ...
        max-2xl:pt-[60px]
        max-2xl:pr-[250px]
        max-2xl:pb-[60px] max-2xl:pl-[60px] max-lg:gap-[30px]  max-lg:pt-[30px] max-lg:pr-[20px] max-lg:pb-[30px] max-lg:pl-[20px] ${hight} `}
      >
        <div className={`font-robotom flex flex-col gap-[30px] max-2xl:gap-6 max-lg:gap-5`}>
          <h2 className="font-medium text-5xl leading-[100%] tracking-normal uppercase max-2xl:text-[38px] max-lg:text-[28px]">
            {heading}
