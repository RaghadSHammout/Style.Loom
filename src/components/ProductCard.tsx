...
export default function ProductCard({ id, ProductImage, category, ProductName, Fitvalue, Pricevalue }: ProductCardProps) {
    return (
        <Link to={`/product/${id}`} className="block" >
            <div className="ProductCard flex  flex-col gap-[20px] md:gap-[24px] 2xl:gap-[30px] h-full max-w-[358px] sm:max-w-[426.67px] 2xl:max-w-[532px]  px-[20px] pt-[20px] pb-[30px] 2xl:p-[30px] border-[1px] md:border-[1.5px] 2xl:border-2 border-dashed border-dark-15">
