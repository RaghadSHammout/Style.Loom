...
function ShopNowButton({
  ...
  const widthClass = inHeroSection ? "w-[128px]" : hasFullWidth ? "w-full" : "w-[128px]";
  ...
  return (
    ...
    >
      ...
      {hasBorder && <img className="absolute top-[-1px] left-[-1px]" src={Line1} alt="Line1" />}
      {hasBorder && <img className="absolute top-[-1px] right-[-1px]" src={Line2} alt="Line2" />}
      {hasBorder && <img className="absolute top-full -translate-y-full right-[-1px]" src={Line3} alt="Line3" />}
      {hasBorder && <img className="absolute top-full -translate-y-full left-[-1px]" src={Line4} alt="Line4" />}
    </NavLink>
  );
}
