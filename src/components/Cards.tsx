  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <h3
          className={`font-roboto font-medium text-white mb-2.5 sm:mb-3 2xl:mb-[16px] leading-[150%] ${(showimage === ShowImageType.one || showimage === ShowImageType.three) ? 'text-lg sm:text-xl 2xl:text-2xl ' : ""}
