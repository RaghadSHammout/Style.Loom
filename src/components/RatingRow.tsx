...
export default function RatingRow({ stars, percentage }: RatingRowProps) {
    return (
        <div className="flex items-center gap-[12px] md:gap-[16px] 2xl:gap-[20px] w-full">
            ...
            <span className="font-normal text-sm md:text-base 2xl:text-lg leading-[150%] font-roboto text-gray-50">0{stars}</span>
