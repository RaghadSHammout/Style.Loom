...
export default function ProductCard({
  ...
  const noBorderBInLast3Item =
    index === productLength - 1 ||
    index === productLength - 2 ||
    index === productLength - 3
      ? "lg:!border-b-0"
      : "";
  const noBorderBInLast2Item =
    index === productLength - 1 || index === productLength - 2
      ? "sm:!border-b-0"
      : "";
  return (
    <Link
   ...
   `}
    >
        ...
        <div className="flex flex-col gap-[20px] md:gap-[24px] 2xl:gap-[30px] h-full w-full">
          <img
          ...
          <div className="flex flex-col gap-[20px] md:gap-[16px] 2xl:gap-[20px] w-full">
            ...
            <div className="flex flex-col gap-[10px] 2xl:gap-[14px]">
              <h4 className="font-medium text-lg 2xl:text-2xl leading-[150%] dark:text-white text-dark-12">
                {product.ProductName}
              </h4>
